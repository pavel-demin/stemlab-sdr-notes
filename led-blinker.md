...
To write the image to a micro SD card, copy the contents of the SD card image zip file to a freshly unpacked micro SD card factory-formatted with the FAT32 file system.
